  ...
  networks: main('networks', {
    ethereum: {
      7106: {
        ...
        name: 'ElonChain',
        isTestnet: false,
        explorer: 'https://scan.eloncoin.org',
        gas: {
          price: {
            selected: 'standard',
    ...
    ethereum: {
      7106: {
        ...
        nativeCurrency: {
          ...
          icon: 'https://www.eloncoin.org/static/media/logo_3.0@2x.0d04b729908b01e43d4d.png',
          name: 'EMC',
          decimals: 18
        },
        icon: 'https://www.eloncoin.org/static/media/logo_3.0@2x.0d04b729908b01e43d4d.png',
        primaryColor: 'accent2' // ElonChain
      },
      1: {
        blockHeight: 0,
        gas: {

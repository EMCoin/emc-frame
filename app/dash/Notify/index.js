      ...
      <div className='notifyBoxWrap' onMouseDown={(e) => e.stopPropagation()}>
        <div className='notifyBoxSlide'>
          <div className='notifyBox'>
            ...
            <div className='notifyTitle'>Emc-Frame v0.0.9-beta</div>
            <div className='notifyBody'>
              <div className='notifyBodyBlock notifyBodyBlockBig'>
                We are excited to welcome you to the next iteration of Emc-Frame!
              </div>
              <div className='notifyBodyBlock'>
                Be advised, this version of Emc-Frame is currently in &quot;beta&quot; and will update on a beta
                track
              </div>
              <div className='notifyBodyBlock'>
    ...
    return (
      <div className='notifyBoxWrap' onMouseDown={(e) => e.stopPropagation()}>
        <div className='notifyBox'>
          ...
          <div className='notifyBody'>
            <div className='notifyBodyLine'>
              Emc-Frame will open a block explorer in your browser for transaction:
            </div>

      ...
      <div className={'localSettings cardShow'}>
        <div className='localSettingsWrap'>
          ...
          <div className='signerPermission localSetting' style={{ zIndex: 213 }}>
            ...
            <div className='signerPermissionDetails'>
              <span>Hide Emc-Frame on loss of focus</span>
            </div>
          </div>
          <div className='signerPermission localSetting' style={{ zIndex: 212 }}>
            ...
            <div className='signerPermissionDetails'>Run Emc-Frame when your computer starts</div>
          </div>
          <div className='signerPermission localSetting' style={{ zIndex: 211 }}>
            ...
            <div className='signerPermissionDetails'>{"Mouse to display's right edge to summon Emc-Frame"}</div>
          </div>
          ...
          <div className='signerPermission localSetting' style={{ zIndex: 209 }}>
            ...
            <div className='signerPermissionDetails'>
              <span>Help improve Emc-Frame by anonymously reporting errors</span>
            </div>
          </div>
          ...
          <div className='signerPermission localSetting' style={{ zIndex: 206 }}>
            ...
            <div className='signerPermissionDetails'>
              <span>Set Emc-Frame&apos;s visual theme</span>
            </div>
          </div>
          ...
          <div className='signerPermission localSetting' style={{ zIndex: 199 }}>
            ...
            <div className='signerPermissionDetails'>When should Emc-Frame relock your hot signers?</div>
          </div>
        </div>
      </div>
    )
